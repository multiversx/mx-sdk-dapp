...
> = {
  devnet: {
    ...
    iframeWalletAddress: 'https://devnet-snap.multiversx.com',
  ...
  testnet: {
    ...
    iframeWalletAddress: 'https://testnet-snap.multiversx.com',
  ...
  mainnet: {
    ...
    iframeWalletAddress: 'https://snap.multiversx.com',
