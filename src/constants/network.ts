...
> = {
  devnet: {
    ...
    extrasApiAddress: 'https://devnet-extras-api.multiversx.com',
  ...
  testnet: {
    ...
    extrasApiAddress: 'https://testnet-extras-api.multiversx.com',
  ...
  mainnet: {
    ...
    extrasApiAddress: 'https://extras-api.multiversx.com',
