...
- [Fix window operations crashing in React Native environment](https://github.com/multiversx/mx-sdk-dapp/pull/805)

- [Fix toast progress for batch transactions on navigation](https://github.com/multiversx/mx-sdk-dapp/pull/804)
