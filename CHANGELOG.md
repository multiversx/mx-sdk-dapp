...
- [Upgraded `@multiversx/erdjs-web-wallet-provider` to vesion 2.1.2](https://github.com/multiversx/mx-sdk-dapp/pull/503)
...
- [Updated @multiversx/erdjs-wallet-connect-provider to 2.1.0-beta.1 with @walletconnect 2.0.0-rc.3](https://github.com/multiversx/mx-sdk-dapp/pull/422)
