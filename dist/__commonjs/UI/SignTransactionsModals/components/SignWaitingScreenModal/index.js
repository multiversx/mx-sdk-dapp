...
.dapp-core-component__signWaitingScreenModal-styles__extension {
  color: inherit;
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(Qa));ni={"extension-modal":"dapp-core-component__signWaitingScreenModal-styles__extension-modal",extensionModal:"dapp-core-component__signWaitingScreenModal-styles__extension-modal","modal-container":"dapp-core-component__signWaitingScreenModal-styles__modal-container",modalContainer:"dapp-core-component__signWaitingScreenModal-styles__modal-container",extension:"dapp-core-component__signWaitingScreenModal-styles__extension"}});var ri={};B(ri,{SignWaitingScreenModal:()=>ai});module.exports=C(ri);r();r();var no=b(require("react")),er=require("@fortawesome/free-solid-svg-icons"),an=b(require("classnames"));re();r();var _t=b(require("react"));r();var de=b(require("react"));r();Ao();var pt=()=>!ko();var Kr=()=>po(void 0,null,function*(){return yield Promise.resolve().then(()=>(Co(),Io))}),Yr=()=>(Co(),C(Io)).default,Lo=pt();function ct({ssrGlobalImportCallback:o,ssrImportCallback:e,clientImportCallback:n}){let[t,a]=de.default.useState(Lo?void 0:Yr()),[i,p]=de.default.useState(Lo||n==null?void 0:n()),_=()=>po(this,null,function*(){(o?o():Kr()).then(m=>a(m.default)),e==null||e().then(m=>p(m.default))});return(0,de.useEffect)(()=>{Lo&&_()},[]),{globalStyles:t,styles:i}}function R(o,e){return n=>{let{globalStyles:t,styles:a}=ct({ssrGlobalImportCallback:e.ssrGlobalStyles,ssrImportCallback:e.ssrStyles,clientImportCallback:e.clientStyles});return _t.default.createElement(o,I(x({},n),{globalStyles:t!=null?t:{},styles:a!=null?a:{}}))}}r();bo();r();var Pa=require("react"),ie=require("react-redux");r();var qo=require("@reduxjs/toolkit"),Ma=require("react-redux/lib/utils/Subscription");fe();r();var ga=b(require("lodash.throttle"));re();fe();Fo();Ne();se();var Tp=[Ce],$e=!1,Sp=(0,ga.default)(()=>{ge(le())},5e3),ua=o=>e=>n=>{if(Tp.includes(n.type))return e(n);let t=o.getState(),a=pe.local.getItem(Z.loginExpiresAt);if(!Boolean(t==null?void 0:t.account.address))return e(n);if(a==null)return ge(le());let p=Date.now();return a-p<0&&!$e?setTimeout(()=>{$e=!0,o.dispatch(It())},1e3):($e&&($e=!1),Sp()),e(n)};r();r();function Ze(){return typeof sessionStorage!="undefined"}var Ra=Ze()?(wa(),C(ya)).default:(Sa(),C(Ta)).default,Na=Ze()?(ka(),C(va)).default:[],Ea=Ze()?(La(),C(Ca)).default:o=>o;Qe();var eo=(0,qo.configureStore)({reducer:Ra,middleware:o=>o({serializableCheck:{ignoredActions:[...Na,St.type,Tt.type],ignoredPaths:["payload.nonce","account.account.nonce","providers.accountProvider"]}}).concat(ua)}),Ba=(0,Ma.createSubscription)(eo),$d=Ea(eo),Zd=(0,qo.configureStore)({reducer:Q});var qp={store:eo,subscription:Ba},Xo=(0,Pa.createContext)(qp),ns=(0,ie.createStoreHook)(Xo),Fa=(0,ie.createDispatchHook)(Xo),ts=(0,ie.createSelectorHook)(Xo);fe();function Da(){let o=Fa();return e=>{o(pa()),o(Zt(e)),o(ia(Mn))}}r();var Ka=b(require("react"));r();r();r();var X=b(require("react")),ja=require("react"),Va=require("react"),Zo=b(require("classnames")),qa=require("react-dom");re();r();var Ua=b(require("react")),Oa=b(require("classnames"));var Kp=({className:o,children:e,styles:n})=>Ua.default.createElement("div",{className:(0,Oa.default)(n==null?void 0:n.dappModalBody,o)},e),Ko=R(Kp,{ssrStyles:()=>Promise.resolve().then(()=>(q(),V)),clientStyles:()=>(q(),C(V)).default});r();var Yo=b(require("react")),Ga=b(require("classnames"));var Yp=({visible:o,customFooter:e,className:n,footerText:t,styles:a})=>o?Yo.default.createElement("div",{className:(0,Ga.default)(a==null?void 0:a.dappModalFooter,n)},e!=null?e:Yo.default.createElement("div",null,t)):null,Jo=R(Yp,{ssrStyles:()=>Promise.resolve().then(()=>(q(),V)),clientStyles:()=>(q(),C(V)).default});r();var ce=b(require("react")),za=require("@fortawesome/free-solid-svg-icons"),Ha=require("@fortawesome/react-fontawesome"),xe=b(require("classnames"));var Jp=({visible:o,headerText:e,customHeader:n,className:t,closeButtonClassName:a,headerTextClassName:i,onHide:p,globalStyles:_,styles:m})=>o?n?ce.default.createElement("div",{className:(0,xe.default)(m==null?void 0:m.dappModalHeader,t)},n):ce.default.createElement("div",{className:(0,xe.default)(m==null?void 0:m.dappModalHeader,t)},ce.default.createElement("div",{className:(0,xe.default)(m==null?void 0:m.dappModalHeaderText,i)},e),ce.default.createElement("button",{onClick:p,className:(0,xe.default)(m==null?void 0:m.dappModalCloseButton,_==null?void 0:_.btn,_==null?void 0:_.btnLight,a)},ce.default.createElement(Ha.FontAwesomeIcon,{size:"lg",icon:za.faTimes}))):null,$o=R(Jp,{ssrStyles:()=>Promise.resolve().then(()=>(q(),V)),clientStyles:()=>(q(),C(V)).default});var Zp={showHeader:!0,showFooter:!1,headerText:"",footerText:""},Qp=({"data-testid":o="dappModal",children:e,className:n="dapp-modal-dialog-wrapper",closeOnEscape:t,config:a=Zp,id:i="dapp-modal",onHide:p,parentElement:_,visible:m,styles:g})=>{let[h,f]=(0,ja.useState)(!1);if((0,Va.useEffect)(()=>{f(!0)},[]),!m)return null;let{showHeader:T,showFooter:S,headerText:E,footerText:ee,modalDialogClassName:ye="dapp-modal-dialog",modalContentClassName:to="dapp-modal-dialog-content",modalHeaderClassName:ao="dapp-modal-dialog-header",modalHeaderTextClassName:ro="dapp-modal-dialog-header-text",modalCloseButtonClassName:M="dapp-modal-dialog-close-button",modalBodyClassName:or="dapp-modal-dialog-content-body",modalFooterClassName:nr="dapp-modal-dialog-footer",customModalHeader:tr,customModalFooter:ar}=a,rr=pr=>{pr.key==="Escape"&&t&&(p==null||p())};return X.default.createElement(X.default.Fragment,null,h&&(0,qa.createPortal)(X.default.createElement("div",{id:i,role:"dialog","aria-modal":"true",className:(0,Zo.default)(ye,g==null?void 0:g.dappModal,n),"data-testid":o,onKeyDown:rr},X.default.createElement("div",{className:(0,Zo.default)(g==null?void 0:g.dappModalContent,to)},X.default.createElement($o,{visible:T,headerText:E,customHeader:tr,className:ao,headerTextClassName:ro,closeButtonClassName:M,onHide:p}),X.default.createElement(Ko,{className:or},e),X.default.createElement(Jo,{visible:S,customFooter:ar,footerText:ee,className:nr}))),_!=null?_:document==null?void 0:document.body))},Qo=R(Qp,{ssrStyles:()=>Promise.resolve().then(()=>(q(),V)),clientStyles:()=>(q(),C(V)).default});r();r();var oo=require("react"),Xa=o=>{let[e,n]=(0,oo.useState)(!1),t=()=>{n(!0)},a=()=>{n(!1)};return(0,oo.useEffect)(()=>{(o==null?void 0:o.visible)===!0?t():(o==null?void 0:o.visible)===!1&&a()},[o==null?void 0:o.visible]),{handleShowModal:t,handleHideModal:a,showModal:e}};r();var Ya=o=>{let{showModal:e}=Xa({visible:o.visible}),n=()=>{var t;(t=o.onClose)==null||t.call(o)};return Ka.default.createElement(Qo,{className:o.className,closeOnEscape:o.closeOnEscape,config:o.modalConfig,onHide:n,visible:e},o.children)};r();r();var K=b(require("react")),$a=require("@fortawesome/react-fontawesome"),be=b(require("classnames"));var oi=({icon:o,title:e,action:n,iconClass:t,"data-testid":a,description:i,iconBgClass:p,iconSize:_="5x",className:m="dapp-page-state",globalStyles:g,styles:h})=>{let f=(0,K.useMemo)(()=>({wrapper:(0,be.default)(h==null?void 0:h.state,g==null?void 0:g.mAuto,g==null?void 0:g.p4,g==null?void 0:g.textCenter,m),iconContainer:(0,be.default)(g==null?void 0:g.iconState,g==null?void 0:g.mxAuto,{[p!=null?p:""]:Boolean(p)}),iconClass:(0,be.default)(t!=null&&t),title:(0,be.default)(g==null?void 0:g.h4,g==null?void 0:g.my4),description:g==null?void 0:g.mb3}),[g,h,m,p,t]);return K.default.createElement("div",{className:f.wrapper,"data-testid":a},o&&K.default.createElement("span",{className:f.iconContainer},K.default.createElement($a.FontAwesomeIcon,{icon:o,className:f.iconClass,size:_})),e&&K.default.createElement("p",{className:f.title},e),i&&K.default.createElement("div",{className:f.description},i),n)},Za=R(oi,{ssrStyles:()=>Promise.resolve().then(()=>(on(),en)),clientStyles:()=>(on(),C(en)).default});var ti=({handleClose:o,error:e,title:n,description:t,sessionId:a,className:i="dapp-extension-modal",modalContentClassName:p,globalStyles:_,styles:m})=>{let g=Da(),h={wrapper:(0,an.default)(m==null?void 0:m.modalContainer,m==null?void 0:m.extension,i),icon:_==null?void 0:_.textWhite,closeBtn:(0,an.default)(_==null?void 0:_.btn,_==null?void 0:_.btnCloseLink,_==null?void 0:_.btnDark,_==null?void 0:_.textWhite,_==null?void 0:_.mt2)},f=T=>{T.preventDefault(),o(),g(a)};return no.default.createElement(Ya,{onClose:o,modalConfig:{modalDialogClassName:h.wrapper},visible:!0},no.default.createElement(Za,{icon:e?er.faTimes:null,iconClass:h.icon,className:p,iconBgClass:e?_==null?void 0:_.bgDanger:_==null?void 0:_.bgWarning,iconSize:"3x",title:n,description:t,action:no.default.createElement("button",{id:"closeButton","data-testid":"closeButton",onClick:f,className:h.closeBtn},"Close")}))},ai=R(ti,{ssrStyles:()=>Promise.resolve().then(()=>(tn(),nn)),clientStyles:()=>(tn(),C(nn)).default});0&&(module.exports={SignWaitingScreenModal});
/*!
